...
- Tags `v0.1.0`, `v0.2.0`, `v0.3.0`, `v0.4.0`, `v0.5.0`, and `v0.5.1` mark published package releases; `0.5.2` is being prepared as a patch release.
...
- Test suite status:
  - `dotnet test W3Css.Blazor.slnx --configuration Release --no-build /nr:false` -> **486 passing tests**.
- Build status:
...
- Current package release is published as `W3Css.Blazor` version `0.5.1`; package metadata targets `0.5.2` for the next patch release.
- Releases `v0.1.0`, `v0.2.0`, `v0.3.0`, `v0.4.0`, `v0.5.0`, and `v0.5.1` are published with package artifacts.
