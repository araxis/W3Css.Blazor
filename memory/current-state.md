...
- Tags `v0.1.0`, `v0.2.0`, `v0.3.0`, `v0.4.0`, `v0.5.0`, and `v0.5.1` mark published package releases.
...
- Current package release is published as `W3Css.Blazor` version `0.5.1`; package metadata targets `0.5.1`.
