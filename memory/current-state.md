...
- Tags `v0.1.0`, `v0.2.0`, `v0.3.0`, `v0.4.0`, `v0.5.0`, `v0.5.1`, `v0.5.2`, `v0.5.3`, and `v0.6.0` mark published package releases.
...
- Test suite status:
  - `dotnet test W3Css.Blazor.slnx --configuration Release --no-build /nr:false` -> **488 passing tests**.
- Build status:
